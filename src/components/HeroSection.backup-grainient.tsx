...
export default function HeroSection() {
  ...
  return (
    <section id="hero" className="w-full min-h-screen relative overflow-hidden flex items-center justify-center pt-28 pb-16">
      ...
      {/* Dynamic full-bleed Grainient background just for the landing page */}
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[#F3F4F6]/50 to-[#F3F4F6] z-0 pointer-events-none" />
