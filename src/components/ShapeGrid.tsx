...
interface ShapeGridProps {
  ...
  borderColor?: string;
  squareSize?: number;
  size?: number; // Support size prop as alias/override
  hoverFillColor?: string;
  hoverColor?: string; // Support alternate naming
...
export default function ShapeGrid({
  ...
  const squareSize = size || propSquareSize;
  ...
  useEffect(() => {
    ...
    const drawGrid = () => {
      ...
      // Smooth radial transparent overlay mapping
      ...
      gradient.addColorStop(1, "rgba(249, 250, 251, 0.45)"); // Blend cleanly with background-1 (#F9FAFB)
  ...
  }, [direction, speed, borderColor, activeHoverColor, squareSize, shape, hoverTrailAmount]);
