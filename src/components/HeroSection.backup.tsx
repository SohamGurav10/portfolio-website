...
export default function HeroSection() {
  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center pt-28 pb-16 px-4 md:px-8 max-w-7xl mx-auto w-full relative">
      
      {/* Editorial top layout lines */}
      <div className="absolute top-24 left-4 right-4 h-[1px] bg-black/[0.05] pointer-events-none hidden md:block" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center w-full relative z-10">
        ...
        <div className="lg:col-span-7 flex flex-col items-start text-left space-y-8 order-2 lg:order-1">
          ...
          <motion.h1 
            ...
            className="text-5xl md:text-7xl xl:text-8xl font-semibold tracking-tighter leading-[0.95] text-primary-text uppercase font-sans etched-heading text-on-glass"
          >
            ENGINEERING <br className="hidden md:inline" />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-palatinate-blue via-secondary-text to-primary-text">
              INTELLIGENT
            </span> <br />
            SYSTEMS.
          </motion.h1>
