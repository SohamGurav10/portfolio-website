          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 items-start text-left">
            ...
            <div className="space-y-8 flex flex-col items-center md:items-start text-center md:text-left order-1 lg:order-1">
              ...
              <a
                ...
                className="group flex items-center gap-2.5 rounded-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-palatinate-blue"
              >
                <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-palatinate-blue font-mono text-sm font-bold text-white shadow-[0_4px_12px_rgba(23,61,237,0.2)] transition-transform group-hover:scale-105">
                  SG
                </span>
                <span className="font-sans text-xl font-bold tracking-tighter text-primary-text transition-colors group-hover:text-palatinate-blue">
                  soham gurav
                </span>
              </a>
              ...
              <div className="space-y-4 flex flex-col items-center md:items-start">
                ...
                <div className="flex w-fit items-center gap-2.5 rounded-[1.2rem] border border-white/95 bg-white/50 px-3.5 py-2 font-mono text-[12px] font-bold uppercase tracking-wider text-secondary-text shadow-[0_2px_8px_rgba(0,0,0,0.01)]">
